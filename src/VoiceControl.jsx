...
const VoiceControl = () => {
  ...
  let intro =
    "Hello. You can read many types of books here. You can say the following words to change direction. 'Home' is to go to the home page. 'Books' is to go to the all books page. 'Blogs' is to go to the blogs page. 'Contact' is to go to the contact us page. 'Down' to scroll down the web page. 'Up' to scroll the web page up. 'Top' to scroll to the top of the web page. 'Bottom' to scroll to the bottom of the web page. 'Normal' to switch the website to normal mode. Do not click on the screen while listening. 'Help me' to hear the instructions again";
  let recognition;
  useEffect(() => {
    ...
    //       setResponse(
    //         "Microphone is disabled, Please wait a moment while we reboot."
    //       );
    //     }
    //   });
